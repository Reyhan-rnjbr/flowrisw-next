  ...
  return (
    <div className="px-4 py-10 md:py-14 md:px-6 lg:py-16">
      <div className="mx-auto w-full max-w-6xl">
        <h2 className="font-bold leading-tight tracking-tight font-display text-slate-700 text-3xl  text-center mb-12">
          Robust features
        </h2>
        <div className=" grid sm:grid-cols-2 lg:grid-cols-4 max-w-5xl gap-x-8 gap-y-12 mx-auto sm:place-items-start place-items-center">
          <div className="max-w-xs grid sm:place-items-start place-items-center">
            <div className="mb-5">
              ...
              <h3 className="leading-tight tracking-tight font-display text-slate-700 text-2xl md:text-3xl mb-3 font-medium sm:text-left text-center">
                Scheduling
              </h3>
              <p className="text-[16px] font-medium font-body text-slate-600 sm:text-left text-center">Create task schedules synced to your natural energy peaks and troughs.</p>
            </div>
          </div>
          <div className="max-w-xs grid sm:place-items-start place-items-center">
            <div className="mb-5">
              ...
              >
                <g
                  stroke="#0891B2"
                  stroke-width="5"
                  clip-path="url(#clip0_1_1478)"
                >
                  <path stroke-linecap="round" d="M73.3 73.3H6.7"></path>
                  <path
                    stroke-opacity="0.5"
              ...
              <p className="text-[16px] font-medium font-body text-slate-600 sm:text-left text-center">
          ...
          <div className="max-w-xs grid sm:place-items-start place-items-center">
            <div className="mb-5">
              ...
              <h3 className="leading-tight tracking-tight font-display text-slate-700 text-2xl md:text-3xl mb-3 font-medium sm:text-left text-center">Integrations</h3>
              <p className="text-[16px] font-medium font-body text-slate-600 sm:text-left text-center">
